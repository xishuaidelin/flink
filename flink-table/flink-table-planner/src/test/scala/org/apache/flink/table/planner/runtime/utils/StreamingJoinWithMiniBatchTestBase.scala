...
class StreamingJoinWithMiniBatchTestBase(miniBatch: MiniBatchMode, state: StateBackendMode)
  ...
  override def before(): Unit = {
    ...
    miniBatch match {
      case MiniBatchOn =>
        tableConfig.set(
          ExecutionConfigOptions.TABLE_EXEC_STREAM_JOIN_MINI_BATCH_ENABLED,
          Boolean.box(true))
...
object StreamingJoinWithMiniBatchTestBase {
