...
public final class StreamingMiniBatchJoinOperatorTest extends StreamingJoinOperatorTestBase {
    ...
    public void testLeftJoinWithHasUniqueKey() throws Exception {
        ...
        assertor.shouldEmit(
                ...
                rowOfKind(
                        ...
                        "LineOrd#2",
                        "SHIP"),
                //        +I(Ord#2,LineOrd#2,4 Bellevue Drive, Pottstown, PB 19464,null,null,null),
                //        -D(Ord#2,LineOrd#2,4 Bellevue Drive, Pottstown, PB 19464,null,null,null),
                rowOfKind(
                        RowKind.INSERT,
                        "Ord#2",
                        "LineOrd#2",
    ...
    @Test
    @Tag("miniBatchSize=2")
    @DisplayName("LeftJoinHasUniqueKeyRetAndAcc")
    ...
    @Tag("miniBatchSize=2")
    @DisplayName("LeftJoinJoinKeyContainsUniqueKeyRetAndAcc")
    @Test
    ...
    public MiniBatchStreamingJoinOperator createJoinOperator(TestInfo testInfo) {
        RowDataKeySelector[] keySelectors0 = ukSelectorExtractor.apply(testInfo.getDisplayName());
                ...
                if (testDisplayName.contains("JoinKeyContainsUniqueKey")) {
                    return new JoinInputSideSpec[] {
                        JoinInputSideSpec.withUniqueKeyContainedByJoinKey(
                                new int[] {1}, leftTypeInfo, leftUniqueKeySelector),
                        JoinInputSideSpec.withUniqueKeyContainedByJoinKey(
                                new int[] {1}, rightTypeInfo, rightUniqueKeySelector)
                    };
                } else if (testDisplayName.contains("HasUniqueKey")) {
                    return new JoinInputSideSpec[] {
                        JoinInputSideSpec.withUniqueKey(
                                new int[] {0}, leftTypeInfo, leftUniqueKeySelector),
                        JoinInputSideSpec.withUniqueKey(
                                new int[] {0}, rightTypeInfo, rightUniqueKeySelector)
                    };
                } else {
                    return new JoinInputSideSpec[] {
